// Package qlbridge is the qlbridge-backed SQL parser front-end. It uses qlbridge
// purely as a SQL parser: rule text → qlbridge AST → unified IR. qlbridge never
...
// New returns a qlbridge parser front-end.
func New() *Parser { return &Parser{} }

// Name identifies the parser.
func (*Parser) Name() string { return "qlbridge" }
...
// toIR converts a qlbridge AST node into the project IR.
func toIR(n expr.Node) (ir.Node, error) {
	switch t := n.(type) {
